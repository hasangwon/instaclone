        ...
        return (
          <article className="feed" key={el.id}>
            <div className="feedBox">
              <Member id={el.name} class="profile" name={el.koreanName} image="images/pic1.jpg" />
            </div>
            ...
            <div className="heartLine">
              <img className="likeProfile" src="images/pic1.jpg" alt="profile" />
              <span className="text">
            ...
            <InputCommentBox commentBox={commentBox} setCommentBox={setCommentBox} idx={idx} />
          </article>
        );
      })}
    </>
