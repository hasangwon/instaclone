    ...
    <div className="login">
      <div className="loginWrapper">
        ...
        <form className="loginInputBox" onSubmit={goToMain}>
          <input type="text" className="idBox" name="userId" placeholder="전화번호, 사용자 이름 또는 이메일" onChange={getUserInfo} />
          <input type="password" className="pwBox" name="userPw" placeholder="비밀번호" onChange={getUserInfo} />
          <input type="submit" id="logins" className="login" disabled={isValid ? false : true} onClick={goToMain} value="로그인" />
        </form>
